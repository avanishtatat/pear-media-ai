      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-2 mb-6 border-b border-gray-200">
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 font-medium transition ${activeTab === 'text'
          ...
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 font-medium transition ${activeTab === 'image'
                ? 'text-indigo-600 border-b-2 border-indigo-600'
                : 'text-gray-500 hover:text-gray-700'
              }`}
          >
